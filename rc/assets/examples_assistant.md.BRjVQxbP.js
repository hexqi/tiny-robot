const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Assistant.DRDEpGfb.js","assets/chunks/framework.U2ZTR3kK.js","assets/chunks/theme.DkLxfybF.js","assets/chunks/index.6Mq2_Mjc.js"])))=>i.map(i=>d[i]);
import{p,D as c,v as m,V as d,C as u,c as g,o as y,j as s,af as x,G as t,a as v,ag as h,k as n,w as l,ai as f}from"./chunks/framework.U2ZTR3kK.js";import{L as b,N as w}from"./chunks/index.m4jssMWy.js";const I=`<template>
  <tr-container
    v-dropzone="{
...
`,_=JSON.parse('{"title":"综合示例","description":"","frontmatter":{},"headers":[],"relativePath":"examples/assistant.md","filePath":"examples/assistant.md"}'),k={name:"examples/assistant.md"},D=Object.assign(k,{setup(S){const i=p(!0),o=c();return m(async()=>{o.value=(await d(async()=>{const{default:a}=await import("./chunks/Assistant.DRDEpGfb.js");return{default:a}},__vite__mapDeps([0,1,2,3]))).default}),(a,e)=>{const r=u("ClientOnly");return y(),g("div",null,[e[1]||(e[1]=s("h1",{id:"综合示例",tabindex:"-1"},[v("综合示例 "),s("a",{class:"header-anchor",href:"#综合示例","aria-label":'Permalink to "综合示例"'},"​")],-1)),x(t(n(b),null,null,512),[[h,i.value]]),t(r,null,{default:l(()=>[t(n(w),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{i.value=!1}),vueCode:n(I)},f({_:2},[o.value?{name:"vue",fn:l(()=>[t(n(o))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{_ as __pageData,D as default};
