const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/lifecycle.BgpSEgJ1.js","assets/chunks/style.DqpIIaGS.js","assets/chunks/framework.BxUN6Jop.js","assets/chunks/selection-scope.LX_cNrog.js","assets/chunks/context.C_zf8UAH.js","assets/chunks/recommendations.BwT2T3FC.js","assets/chunks/trigger-delay.Cw9npnWn.js","assets/chunks/vue-chat.fFvL-Xhd.js","assets/chunks/theme.115_1eJ8.js"])))=>i.map(i=>d[i]);
...
`,W="/tiny-robot/alpha/assets/vanilla.umd.To8IjuGw.js",Z=JSON.parse('{"title":"QuickAssist 智能帮助","description":"","frontmatter":{"outline":[1,3]},"headers":[],"relativePath":"components/quick-assist.md","filePath":"components/quick-assist.md"}'),P={name:"components/quick-assist.md"},V=Object.assign(P,{setup(R){const m=g();k(async()=>{m.value=(await c(async()=>{const{default:e}=await import("./chunks/lifecycle.BgpSEgJ1.js");return{default:e}},__vite__mapDeps([0,1,2]))).default});const b=g();k(async()=>{b.value=(await c(async()=>{const{default:e}=await import("./chunks/selection-scope.LX_cNrog.js");return{default:e}},__vite__mapDeps([3,1,2]))).default});const F=g();k(async()=>{F.value=(await c(async()=>{const{default:e}=await import("./chunks/context.C_zf8UAH.js");return{default:e}},__vite__mapDeps([4,1,2]))).default});const f=g();k(async()=>{f.value=(await c(async()=>{const{default:e}=await import("./chunks/recommendations.BwT2T3FC.js");return{default:e}},__vite__mapDeps([5,1,2]))).default});const v=g();k(async()=>{v.value=(await c(async()=>{const{default:e}=await import("./chunks/trigger-delay.Cw9npnWn.js");return{default:e}},__vite__mapDeps([6,1,2]))).default});const n=_(!0),A=g();return k(async()=>{A.value=(await c(async()=>{const{default:e}=await import("./chunks/vue-chat.fFvL-Xhd.js");return{default:e}},__vite__mapDeps([7,8,2,1]))).default}),typeof window<"u"&&(window.__tinyRobotVanillaDemoUmdUrl=W),(e,s)=>{const d=x("ClientOnly");return C(),q("div",null,[s[7]||(s[7]=u(`<h1 id="quickassist-智能帮助" tabindex="-1">QuickAssist 智能帮助 <a class="header-anchor" href="#quickassist-智能帮助" aria-label="Permalink to &quot;QuickAssist 智能帮助&quot;">​</a></h1><p>QuickAssist 是一个与框架无关的智能帮助组件，可以用在需要在页面中进行轻量AI交互的场景。当前提供了“划词”触发和输入交互，用户选中页面中的文字后，可以查看推荐问题、编辑问题，并把问题和有限上下文交给应用已有的 AI 对话面板。它只负责划词触发和输入交互，不包含回答展示、模型调用或完整聊天界面。</p><h2 id="安装与引入" tabindex="-1">安装与引入 <a class="header-anchor" href="#安装与引入" aria-label="Permalink to &quot;安装与引入&quot;">​</a></h2><h3 id="npm-方式" tabindex="-1">NPM 方式 <a class="header-anchor" href="#npm-方式" aria-label="Permalink to &quot;NPM 方式&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">npm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> @opentiny/tiny-robot</span></span></code></pre></div><p>从 TinyRobot NPM 包的<code>/vanilla</code> 子路径导入，并显式加载组件样式：</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { createQuickAssist } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@opentiny/tiny-robot/vanilla&#39;</span></span>
