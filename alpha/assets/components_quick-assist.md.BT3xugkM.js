...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    },</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }),</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">})</span></span></code></pre></div><p>默认采集不会读取整页 <code>body.innerText</code> 或表单值。选区与附近文本会跳过常见编辑区和敏感标记，但通用规则不能识别所有业务秘密。请通过 <code>sanitizeContext</code> 删除访问密钥、令牌、用户或租户 ID、订单数据等，并在页面上为敏感区域添加 <code>data-sensitive</code> 或 <code>data-ai-selection=&quot;false&quot;</code>。不要把 DOM、<code>Range</code> 或选区快照序列化后传给模型。</p><h3 id="生效范围与选择长度" tabindex="-1">生效范围与选择长度 <a class="header-anchor" href="#生效范围与选择长度" aria-label="Permalink to &quot;生效范围与选择长度&quot;">​</a></h3><p>试着选择示例中允许的文字、排除区域，以及超过长度限制的句子，比较划词入口是否出现。</p>`,7)),p(i(t(o),null,null,512),[[d,n.value]]),i(l,null,{default:a(()=>[i(t(r),{title:"可选择区域与长度限制",description:"仅指定区域和有效长度的选区会显示划词入口。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[4]||(s[4]=()=>{n.value=!1}),vueCode:t(_)},u({_:2},[m.value?{name:"vue",fn:a(()=>[i(t(m))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),s[13]||(s[13]=E(`<div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> quickAssist</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> createQuickAssist</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  adapter,</span></span>
