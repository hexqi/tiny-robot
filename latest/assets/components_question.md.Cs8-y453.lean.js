...
`,P=JSON.parse('{"title":"Question 快捷问题组件","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"components/question.md","filePath":"components/question.md"}'),_={name:"components/question.md"},T=Object.assign(_,{setup(C){const d=r(!0),o=c();return u(async()=>{o.value=(await p(async()=>{const{default:i}=await import("./chunks/Base.DumROyDx.js");return{default:i}},__vite__mapDeps([0,1,2,3,4,5]))).default}),(i,t)=>{const s=h("ClientOnly");return g(),m("div",null,[t[1]||(t[1]=a("",5)),b(e(n(q),null,null,512),[[f,d.value]]),e(s,null,{default:l(()=>[e(n(y),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,onMount:t[0]||(t[0]=()=>{d.value=!1}),vueCode:n(v)},x({_:2},[o.value?{name:"vue",fn:l(()=>[e(n(o))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[2]||(t[2]=a("",13))])}}});export{P as __pageData,T as default};
